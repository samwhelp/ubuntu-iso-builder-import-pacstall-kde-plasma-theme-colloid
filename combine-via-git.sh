...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-colloid"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-kde-plasma-theme-colloid/iso-profile
"
echo
